...
public class ControlPoint extends ControlPointGUI implements Runnable {
    ...
    private static javax.swing.JCheckBox cbSave;
...
//        sSpinner.setVisible(false);
        cbSave.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            @Override
        ...
        ChangeListener changeListener = new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                isSave = cbSave.isSelected();
                Preference.savePref(isSave);
            }
        };
        cbSave.addChangeListener(changeListener);
...
//            dDeviceBox.setVisible(false);
    ...
    public static void main(String[] args) throws Exception {
        ...
        clientThread.start();
        isSave = Preference.readPref();
        cbSave.setSelected(isSave);
        if (isSave) {
